module const
  ...
  implicit none
  integer, parameter :: nx    = 18001     ! number of grid points in x
  integer, parameter :: ny    = 32*120    ! number of grid points in y
  ...
  integer, parameter :: nproc = 240       ! number of processors
