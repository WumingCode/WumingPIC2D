...
def test_moment(fn, it, param, batch=True):
    ...
    plt.subplot(221)
    plt.title(r'$\Omega _{gi}t = %5d$' % (wgi*it*dt) ,fontsize = lsize,y=1.01)
    plt.streamplot(x,y,bx,by)
    plt.imshow(den[1,:,:]/n0,extent=[xmin,xmax,ymax,ymin],vmin=nmin,vmax=nmax,aspect='auto')
    plt.xlim(xmin,xmax)
    plt.ylim(ymin,ymax)
    ax = plt.gca()
    ...
    plt.title(r'$\Omega _{gi}t = %5d$' % (wgi*it*dt) ,fontsize = lsize,y=1.01)
    plt.streamplot(x,y,bx,by)
    plt.imshow(den[0,:,:]/n0,extent=[xmin,xmax,ymax,ymin],vmin=nmin,vmax=nmax,aspect='auto')
    plt.xlim(xmin,xmax)
    plt.ylim(ymin,ymax)
    ax = plt.gca()
    plt.xticks(fontsize=tsize)
    ...
    plt.title(r'$\Omega _{gi}t = %5d$' % (wgi*it*dt) ,fontsize = lsize,y=1.01)
    plt.streamplot(x,y,bx,by)
    plt.imshow(vy[1,:,:]/v0,extent=[xmin,xmax,ymax,ymin],vmin=vmin,vmax=vmax,cmap=cmap1,aspect='auto')
    plt.xlim(xmin,xmax)
    plt.ylim(ymin,ymax)
    ax = plt.gca()
    plt.xticks(fontsize=tsize)
    ...
    cbar.ax.tick_params(labelsize=tsize)
    cbar.set_label(r'$V_{ye}/V_A$',fontsize=lsize)

    plt.subplot(224)
    plt.title(r'$\Omega _{gi}t = %5d$' % (wgi*it*dt) ,fontsize = lsize,y=1.01)
    plt.streamplot(x,y,bx,by)
    plt.imshow(bz/b0,extent=[xmin,xmax,ymax,ymin],vmin=bmin,vmax=bmax,cmap=cmap1,aspect='auto')
    plt.xlim(xmin,xmax)
    plt.ylim(ymin,ymax)
    ax = plt.gca()
    plt.xticks(fontsize=tsize)
    ...
    cbar.ax.tick_params(labelsize=tsize)
    cbar.set_label(r'$B_z/B_0$',fontsize=lsize)
